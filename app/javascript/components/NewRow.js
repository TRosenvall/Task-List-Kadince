      ...
      <React.Fragment>
        <div className="task">
          <div className="inputLeft">
            <input className="newTaskField" type="text" name="taskName" placeholder="New Task..." value={this.props.taskName} onChange={this.props.setTaskName} onFocus={this.props.clearTaskName} />
          </div>
          <div className="right">
